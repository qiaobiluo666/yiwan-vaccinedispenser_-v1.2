 ...
 */
@Data
public class CabinetCSendDrugRequest implements Serializable {
    ...
    private CabinetConstants.CabinetCSendDrugCommand command;

    private Integer mode;

    private CabinetConstants.CabinetCSendDrugBlockStatus status;
