 ...
 */
@Data
public class CabinetBApplyRequest implements Serializable {
    ...
    //工作模式-对应的ab板子 给哪块板子发指令
    @NotNull(message = "工作模式-对应的ab板子")
    private CabinetConstants.CabinetBApplyCommand command;

    @NotNull(message = "工作模式-对应的ab板子")
    private CabinetConstants.CabinetBApplyMode mode;

    //自动上药状态 启动 停止
    private CabinetConstants.CabinetBApplyStatus status;
}
