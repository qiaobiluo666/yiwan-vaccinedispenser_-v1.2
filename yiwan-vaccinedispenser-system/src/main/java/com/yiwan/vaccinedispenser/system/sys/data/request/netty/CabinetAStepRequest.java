 ...
 */
@Data
public class CabinetAStepRequest implements Serializable {
    ...
    private CabinetConstants.CabinetAStepCommand command;

    //步进模式选择
    @NotNull(message = "步进模式选择")
    private CabinetConstants.CabinetAStepMode mode;

    @NotNull(message = "步进运动状态")
    private CabinetConstants.CabinetAStepStatus status;
