...
@Service
@Slf4j
public class VacMachineExceptionServiceImpl extends ServiceImpl<VacMachineExceptionMapper, VacMachineException> implements VacMachineExceptionService {
    ...
    @Override
    public List<VacMachineException> getExceptionByName(String name) {
        LambdaQueryWrapper<VacMachineException> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(VacMachineException::getCode,SettingConstants.MachineException.CONTROLLER.code);
    ...
    @Override
    public void delExceptionByName(List<VacMachineException> vacMachineExceptionList) {
        VacMachineException vacMachineException = new VacMachineException();
        for(VacMachineException record : vacMachineExceptionList){
            vacMachineException.setId(record.getId());
            vacMachineException.setDeleted(1);
            vacMachineExceptionMapper.updateById(vacMachineException);
        }
