 ...
 */
@Data
public class CabinetBServoRequest implements Serializable {
    ...
    private CabinetConstants.CabinetBServoCommand command;
    ...
    private CabinetConstants.CabinetBServoStatus status;
