 ...
 */
@Data
public class CabinetCServoRequest implements Serializable {
    ...
    private CabinetConstants.CabinetCServoCommand command;
    ...
    @NotNull(message = "伺服运动状态")
    private CabinetConstants.CabinetCServoStatus status;
