 ...
 */
@Data
public class CabinetBStepRequest implements Serializable {
    ...
    private CabinetConstants.CabinetBStepCommand command;

    //步进模式选择
    @NotNull(message = "步进模式选择")
    private CabinetConstants.CabinetBStepMode mode;

    @NotNull(message = "步进运动状态")
    private CabinetConstants.CabinetBStepStatus status;
